...
def private_and_public_repository():
    r"""Private and public repository.

    Configure the following repositories:
    * audb-private: repo without access
    * audb-public: repo with anonymous access
    ...
    audb.config.REPOSITORIES = [
        audb.Repository("audb-private", PUBLIC_HOST, PUBLIC_BACKEND),
